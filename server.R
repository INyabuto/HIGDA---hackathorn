...
shinyServer(function(input,output){
  orgUnits <- reactive({
    ...
    resp <- dhis2_rapi2("https://play.dhis2.org/release1/api/organisationUnits.json?paging=false&fields=[name,code,level]")
  ...
  elements <- reactive({
    ...
    resp <- dhis2_rapi2("https://play.dhis2.org/release1/api/dataElements.json?paging=false&fields=[name,code]")
